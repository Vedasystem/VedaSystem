jQuery(function($) {
  ...
  var $_table = $(tableId).DataTable({
    ...
    buttons: {
      ...
      buttons: [
        {
          "extend": "colvis",
          "text": "<i class='far fa-eye text-125 text-dark-m2'></i> <span class='d-none'>Mostrar/Esconder colunas</span>",
        ...
        {
          "extend": "copy",
          "text": "<i class='far fa-copy text-125 text-purple'></i> <span class='d-none'>Copiar para área de tranferência</span>",
          "className": "btn-light-default btn-bgc-white btn-h-outline-primary btn-a-outline-primary"
        },

        {
          "extend": "csv",
          "text": "<i class='fa fa-database text-125 text-success-m1'></i> <span class='d-none'>Exportar arquivo CSV</span>",
          "className": "btn-light-default btn-bgc-white btn-h-outline-primary btn-a-outline-primary"
        },
    ...
    // multiple row selectionSearch Employees
    select: {
      style: 'multis'
    },
  ...
  // and add a "+" button
      .end().append('<a onclick="addTerapeutas()" asp-action="Create" data-rel="tooltip" class="btn radius-round btn-outline-primary border-2 btn-sm ml-2" title="Adicionar Terapeuta"><i class="fa fa-plus"></i></a>')
